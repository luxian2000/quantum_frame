"""Demo: visualize a nexq quantum circuit.
...
from nexq import Circuit, cnot, crx, hadamard, rzz, rz, swap
from nexq.visual import circuit_to_text, draw_circuit, gate_histogram
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Visualize a quantum circuit with nexq.visual.")
    ...
    fig, _ = draw_circuit(circuit, output="mpl", title="nexq circuit visualization")
