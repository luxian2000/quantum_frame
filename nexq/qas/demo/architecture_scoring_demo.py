...
Run from the repository root:
    C:/ProgramData/anaconda3/python.exe nexq/qas/demo/architecture_scoring_demo.py
"""
...
from nexq.qas import build_common_architectures, evaluate_architectures
from nexq.qas.multi_objective_reward import RewardWeights
from nexq.qas import ArchitectureScore
