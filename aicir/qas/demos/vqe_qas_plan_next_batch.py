...
Track A uses a kNN oracle only inside the trust region.  Track B expands
boundary/sparse regions with farthest-first selection and does not use oracle
scores for ranking out-of-region candidates.
"""
...
def main() -> None:
    ...
    parser.add_argument("--batch-id", default="batch_v1")
    ...
    if can_use_oracle:
        ...
        ea_proposals, ea_backend = select_latest_ea_candidates(
            unlabeled_records,
            seeds=seed_records,
