...
from aicir.qas.vqe_qas_protocol import BENCHMARK_TABLE_FIELDS, append_benchmark_rows
...
def main() -> None:
    ...
    plan_command = [
        sys.executable,
        str(repo_root / "aicir" / "qas" / "demos" / "vqe_qas_plan_next_batch.py"),
        "--candidates",
    ...
    calibration_command = [
        sys.executable,
        str(repo_root / "aicir" / "qas" / "demos" / "vqe_qas_calibrate_oracle.py"),
        "--benchmark-table",
