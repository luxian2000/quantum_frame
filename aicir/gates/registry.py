...
_STANDARD_GATES = (
    ...
    GateSpec("cy", 1, 0, controlled=True, qasm_name="cy", symbol="Y", decomposition=decompose_cy),
    GateSpec("cz", 1, 0, controlled=True, qasm_name="cz", symbol="Z", decomposition=decompose_cz),
    GateSpec("crx", 1, 1, controlled=True, qasm_name="crx", symbol="Rx", generator="X"),
    GateSpec("cry", 1, 1, controlled=True, qasm_name="cry", symbol="Ry", generator="Y"),
    GateSpec("crz", 1, 1, controlled=True, qasm_name="crz", symbol="Rz", generator="Z"),
